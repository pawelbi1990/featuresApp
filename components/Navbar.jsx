...
export default function Navbar(props=null) {
    ...
    <div className={id > 0 ? "IconContainer" : "none"} onClick={id > 1 ? props.previous : null}>
    ...
    <div className="IconContainer">
        ...
        <div className={id < lastitem ? "IconContainer" : "IconContainerDisabled"} onClick={id < lastitem ? props.next : null}>
