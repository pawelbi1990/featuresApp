...
const Newfeature = (props) => {
  ...
  return (
    ...
    <Menuv2/>
        ...
        <div className="image-container-preview" style={{ backgroundImage: `url(${imagePreviewURL})` }}>
        ...
        <button className="btn bottom-left-anchor" onClick={nextPage}>Continue</button>
        </div>
